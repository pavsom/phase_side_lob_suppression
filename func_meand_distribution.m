%%
% Функция генерирует Меандровое фазовое распределение с соответствующими
% параметрами.
...
function phase = meandr_distribution(Amp, Nums_y, az0, um0, DATA_X, ...
    DATA_Y, x, y, k)
    ...
    % Формирование меандрового фазового распределения возбуждающего сигнала
    % с соответствующей амплитудой, знаком и периодом к номеру излучателя 
    % по оси Y    
    count = 0;
    for i = 1:length(y)
        ...
        phase_y(i) = koeff * Amp * square(2*pi * (2/T_y) * count);
